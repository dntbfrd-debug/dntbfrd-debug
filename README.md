...
- 🎨 Современный UI на Qt Quick / QML
- 🔐 Активация по ключу + привязка к HWID
...
- 💾 WinAPI / SendInput — низкоуровневый ввод и автоматизация
- 🔎 Tesseract OCR — распознавание текста и данных
- ⚙️ Nuitka — компиляция Python в нативный EXE
