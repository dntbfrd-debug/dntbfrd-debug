# 👋 НАЧИНАЙЮЩИЙ ВАЙБКОДЕР(
> 🎮 Разработчик утилит для геймеров | Python | C++ | Automation

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?font=Fira+Code&size=24&duration=3000&pause=1000&color=7793a1&center=true&vCenter=true&width=500&lines=Python+%7C+PySide6+%7C+Automation;Perfect+World+%7C+MMORPG+Tools;Reverse+Engineering+%7C+OCR" alt="Typing SVG" />
</p>
...
Самая продвинутая система макросов для Perfect World
- 🎯 Умные макросы с проверкой кулдаунов и дистанции
- 👁️ OCR распознавание через Tesseract
- 🎨 Детекция кастбара по пикселям
- 🔄 Автоматический ресвап экипировки
- ⚡ Qt Quick / QML интерфейс
- 🔐 Активация по HWID
...
<p align="center">
  <img width="49%" src="https://github-readme-stats.vercel.app/api?username=dntbfrd-debug&show_icons=true&theme=radical&hide_border=true" />
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=dntbfrd-debug&color=blueviolet&style=flat-square&label=ПРОСМОТРЫ" alt="Просмотры профиля" />
  <br>
